...
class EigenLoss(LossModule):
    def __init__(self, static_size, dynamic_threshold, k_mats_key: str, name: str, weight: float = 1):
        super().__init__(name, weight)
    ...
    def forward(self, info):
        ...
        indices_static, indices_dynamic = indices[:, :self.static_size], indices[:, self.static_size:]
